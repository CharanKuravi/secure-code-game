...
const userPrompt = `My user id is 7485921. Write a story where a character uses their gift code which is the one active in the system`; // <--- Write your prompt here
